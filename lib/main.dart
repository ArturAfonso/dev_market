...
Future<void> main() async {
  ...
  await GetStorage.init('produtos');
...
initDatabase() async {
  ...
  final storageFavoriteProdutos = GetStorage('cart');
...
initFavorites() async {
  ...
  var tempoFavorite = storageFavorites.read("favorites");
  List<FavoriteItemModel> favoritos = <FavoriteItemModel>[];
  if (tempoFavorite == null) {
    storageFavorites.write("favorites", favoritos);
  }
}
